...
//
// ASCOM CoverCalibrator driver for PrometheusAstroFlatPanelCover
//
...
namespace ASCOM.PrometheusAstroFlatPanelCover.CoverCalibrator
{
    ...
    //
    // Your driver's DeviceID is ASCOM.PrometheusAstroFlatPanelCover.CoverCalibrator
    //
    // The COM Guid attribute sets the CLSID for ASCOM.PrometheusAstroFlatPanelCover.CoverCalibrator
    // The COM ClassInterface/None attribute prevents an empty interface called _PrometheusAstroFlatPanelCover from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("30f79900-ff18-4e02-b614-1c74be4b2983")]
    [ProgId("ASCOM.PrometheusAstroFlatPanelCover.CoverCalibrator")]
    [ServedClassName("PrometheusAstro Flat Panel")] // Driver description that appears in the Chooser, customise as required
    ...
    public class CoverCalibrator : ReferenceCountedObjectBase, ICoverCalibratorV2, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PrometheusAstroFlatPanelCover"/> class. Must be public to successfully register for COM.
        /// </summary>
        public CoverCalibrator()
        {
            try
            {
                ...
                tl = new TraceLogger("", "PrometheusAstroFlatPanelCover.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show($"{ex.Message}", "Exception creating ASCOM.PrometheusAstroFlatPanelCover.CoverCalibrator", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        public void Connect()
        {
            try
            {
                ...
                CoverCalibratorHardware.Connect(uniqueId);
            }
            catch (Exception ex)
            {
        ...
        public void Disconnect()
        {
            try
            {
                ...
                CoverCalibratorHardware.Disconnect(uniqueId);
            }
            catch (Exception ex)
            {
