...
; Generated by Polychronis Iliakis on 29/1/2025 (UTC)
;
[Setup]
AppID={{cdfc18b9-7633-456f-ba05-6e44f049fda3}
AppName=ASCOM PrometheusAstro FPC CoverCalibrator Driver
AppVerName=ASCOM PrometheusAstro FPC CoverCalibrator Driver 1.0
AppVersion=1.0
AppPublisher=Polychronis Iliakis <polychronis.iliakis@gmail.com>
AppPublisherURL=mailto:polychronis.iliakis@gmail.com
...
OutputDir="."
OutputBaseFilename="PrometheusAstro FPC Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\CoverCalibrator\PrometheusAstro FPC"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\CoverCalibrator\PrometheusAstro FPC"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "C:\Users\Polychronis\source\repos\PrometheusAstroFlatPanelDriver\bin\Release\ASCOM.PrometheusAstroFlatPanelCover.exe"; DestDir: "{app}" ;AfterInstall: RegASCOM()
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "C:\Users\Polychronis\source\repos\PrometheusAstroFlatPanelDriver\bin\Release\ReadMe.htm"; DestDir: "{app}"; Flags: isreadme
; TODO: Add other files needed by your driver here (add subfolders above)

;Only if COM Local Server
[Run]
Filename: "{app}\ASCOM.PrometheusAstroFlatPanelCover.exe"; Parameters: "/regserver"
...
;Only if COM Local Server
[UninstallRun]
Filename: "{app}\ASCOM.PrometheusAstroFlatPanelCover.exe"; Parameters: "/unregserver"
...
Root: HKCR; Subkey: AppId\{#AppClsid}; ValueType: string; ValueData: "ASCOM PrometheusAstro FPC CoverCalibrator Driver"
...
Root: HKCR; Subkey: AppId\ASCOM.PrometheusAstroFlatPanelCover.exe; ValueType: string; ValueName: AppID; ValueData: {#AppClsid}
; CAUTION! DO NOT EDIT - DELETING ENTIRE APPID TREE WILL BREAK WINDOWS!
Root: HKCR; Subkey: AppId\{#AppClsid}; Flags: uninsdeletekey
Root: HKCR; Subkey: AppId\ASCOM.PrometheusAstroFlatPanelCover.exe; Flags: uninsdeletekey
...
begin
   ...
   P.Register('PrometheusAstro FPC.CoverCalibrator', 'PrometheusAstro Flat Panel Cover');
end;
...
begin
   ...
   begin
     P := CreateOleObject('ASCOM.Utilities.Profile');
     P.DeviceType := 'CoverCalibrator';
     P.Unregister('PrometheusAstro FPC.CoverCalibrator');
  end;
end;
